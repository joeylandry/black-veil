...
export const archiveRecords: ArchiveRecord[] = [
  ...
  {
    slug: "person-of-interest-bulletin",
    catalogNumber: "MPD–24–095",
    date: "November 3, 1924",
    year: 1924,
    title: "Person of Interest Bulletin",
    format: "police",
    excerpt: "A department bulletin names Castello a person of interest, issues no warrant, and asks only that the public report her whereabouts since the masquerade.",
    body: [
      "The Manchester Police Department posted this bulletin at precinct houses and along Elm Street, naming Cassandra Castello, proprietress of The Black Veil, a person of interest in connection with the events of the October 31 masquerade.",
      "The bulletin accuses her of nothing. It states plainly that she is believed to possess information concerning the gathering and asks the public to report any knowledge of her activities or whereabouts afterward. No charge is named and no warrant accompanies the notice.",
      "Copies were reportedly torn down from at least two locations within a day of posting. The department has not said who removed them.",
    ],
    image: {
      ...
      caption: "PERSON OF INTEREST · City of Manchester Police Department · November 1924",
      width: 1122,
      height: 1402,
      focalPoint: "50% 30%",
    },
    markings: ["Torn from post near Elm Street", "No warrant accompanies bulletin"],
    provenance: {
      classification: "generated-historical-fiction",
      label: "Generated historical-fiction image",
      fictional: true,
      sourceInstitution: "The Black Veil creative archive",
      sourceTitle: "Person of Interest Bulletin",
      rights: "Original generated image for this project",
